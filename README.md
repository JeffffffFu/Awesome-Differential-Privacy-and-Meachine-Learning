...
| LDP-FL: Practical Private Aggregation in Federated Learning with Local Differential Privacy | Sun et al.                   | IJCAI/2021        | 提出参数shuffle，并认为进行了参数shuffle后不需要对维度划分隐私预算
