...
| Title                                                                                            | Team/Main Author                 | Venue and Year                                           | Key Description                                                                                                                                                                                                                                                            
|:-------------------------------------------------------------------------------------------------|:---------------------------------|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| Clients Collaborate: Flexible Differentially Private Federated Learning with Guaranteed Improvement of Utility-Privacy Trade-off | SYSU, TAMU, HITSZ, ZSTU                       | ICML/2025 | 提出了首个通过张量低秩优化让客户端参数“协作”以**动态**平滑语义空间的方法（**FedCEO**），在严格差分隐私保护下，将联邦学习的效用-隐私权衡界限提升了√d量级，实现了显著性能提升。[[Paper](https://arxiv.org/abs/2402.07002)] [[Code](https://github.com/6lyc/FedCEO_Collaborate-with-Each-Other)]                                                                                                             | 
