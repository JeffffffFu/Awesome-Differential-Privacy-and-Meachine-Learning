...
| Collecting and Analyzing Data from Smart Device Users with Local Differential Privacy | Rong Du | sensor, mesh and ad hoc communications and networks/2021 | 提出了我们提出了Harmony，用于包含数值和类别属性的多维数据的LDP下的均值和频数统计。主要是连续型数据直接随机的对称扰动成两个相反数，然后保证均值无偏，误差边界比用Lap小。                                                                                                                                    |                                                                                                                                                                                                                              |
